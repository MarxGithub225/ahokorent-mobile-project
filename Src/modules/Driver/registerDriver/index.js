...
const RegisterDriver = (props) => {
  ...
  const [isSecureEntry, setIsSecureEntry] = useState(true);
    ...
    const register = () => {
        ...
        if (userExist) {
          _snackError('Vous êtes déjà chauffeur chez Ahoko, veuillez vous connecter.');
          return;
        }
      const data = {
        lastname: lastname,
    ...
    const {registerDriverReducer} = props;
    return (
      ...
      <View style={style.form}>
        ...
        <Spinner
            visible={registerDriverReducer.loading}
...
export default connect(mapStateToProps, mapDispatchToProps)( RegisterDriver );